...
悬浮层进程同时提供托盘图标：查看配额（含快捷键提示）、音效开关、音效组、大小预设（300/440/580）、开机自启、每轮提示开关、气泡自动收起开关、设置、随机语句…、“本次退出挂件（下次启动 Codex 恢复）”、“完全退出”。
...
```json
{"size":440,"x":2040,"y":1128,"sound":1,"soundSet":0,"hideSeconds":5,"turnSeconds":6,"autoClose":1,"turnNotice":1,"quotes":[{"t":"今天也要好好休息呀～","w":1},{"t":"深呼吸，然后继续～","w":3}]}
```
